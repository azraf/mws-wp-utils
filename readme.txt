=== Wordpress Utilities ===
Contributors: azraf
Tags: wordpress,wordpress-plugin,wordpress-utilities,favicon,copy,phpinfo
...
Add some frequently require functionalities. Admin can easily copy remote file, set favicon to WordPress easily, add google meta tag for verification, remove all woocommerce products at once and check the server information by the phpinfo() function.
